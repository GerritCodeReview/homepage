  ...
  <div class="wrapper">
    <div class="hero-content">
      ...
      <a href="https://gerrit-releases.storage.googleapis.com/gerrit-3.12.2.war" class="btn-modern">Download Gerrit 3.12.2</a>
       <a href="https://gerrithub.io" class="btn-modern btn-outline" _target="blank">
  ...
  <div class="feature__item">
    <div class="archive__item">
      <div class="archive__item-body">
        ...
        <div class="archive__item-excerpt">
          <p>Multi-master setup with high availability, geographic distribution, load balancing, and automated backup strategies for enterprise deployments.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="dev-experience-grid">
    ...
    <div class="dev-experience-card">
      ...
      <div class="dev-experience-content">
        ...
        <a href="https://gerrit.googlesource.com/plugins/" class="btn-modern btn-small">
          <i class="fas fa-puzzle-piece"></i>
          Browse Plugins
        </a>
      </div>
...
<div class="cicd-section">
  ...
  <div class="cicd-grid">
    <div class="cicd-card">
      ...
      <p>Native integration with Jenkins pipelines for automated testing, building, and deployment workflows.</p>
