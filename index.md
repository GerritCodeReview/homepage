...
<div class="hero-section">
  <div class="wrapper">
    <div class="hero-content">
      ...
      <a href="{{ site.data.content.base_urls.gerrit_releases }}/gerrit-{{ site.data.content.latest_version }}.war" class="btn-modern">{{ site.data.content.hero.download_button }} {{ site.data.content.latest_version }}</a>
  ...
  <div class="dev-experience-grid">
    ...
    <div class="dev-experience-card">
      ...
      <div class="dev-experience-content">
        ...
        {% if card.button %}
          {% if card.url_prefix %}
        <a href="{{ site.data.content.base_urls[card.url_prefix] }}{{ card.button_url }}" class="btn-modern btn-small">
          <i class="{{ card.button_icon }}"></i>
          {{ card.button }}
        </a>
          {% elsif card.button_url %}
  ...
  <div class="logo-grid">
    ...
    <div class="logo-item">
      <div class="logo-container">
        {% if logo.icon == 'jgit' %}
        <img src="/images/jgit.svg" alt="JGit Logo" class="jgit-logo">
        {% else %}
        <i class="{{ logo.icon }}"></i>
        {% endif %}
...
<div class="getting-started-grid">
  ...
  <div class="getting-started-card">
    ...
    <div class="card-content">
      ...
      {% endif %}
      {% if card.url_prefix %}
      <a href="{{ site.data.content.base_urls[card.url_prefix] }}{{ card.button_url }}" class="btn-modern btn-small">{{ card.button }}</a>
      {% elsif card.button_url %}
...
<div class="resources-grid">
  ...
  <div class="resource-card">
    ...
    <p>{{ card.text }}</p>
    {% if card.url_prefix %}
    <a href="{{ site.data.content.base_urls[card.url_prefix] }}{{ card.button_url }}" class="resource-link">
    {% elsif card.button_url %}
...
<div class="cta-section">
  <div class="cta-content">
    ...
    <div class="cta-buttons">
      <a href="{{ site.data.content.base_urls.gerrit_releases }}/gerrit-{{ site.data.content.latest_version }}.war" class="btn-modern btn-large">
        <i class="{{ site.data.content.cta.download_button_icon }}"></i>
        {{ site.data.content.cta.download_button }} {{ site.data.content.latest_version }}
      </a>
      <a href="{{ site.data.content.base_urls.documentation }}/" class="btn-modern btn-outline">
