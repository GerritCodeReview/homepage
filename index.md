...
For (virtual) face-to-face contributor discussions there is a monthly Gerrit contributor meeting that is hosted in Gerrit's [Discord server](https://discord.gg/3yF6HAWxg4?event=1304116092494418010). Please watch out for the 'Gerrit Contributor hangout/hacking' event there. Contributors are welcome to join and bring up topics they would like to discuss or changes need help with. The agenda is set as an open time block for Gerrit contributors to join each other online to collaborate on changes, challenges, roadmap items, etc.
