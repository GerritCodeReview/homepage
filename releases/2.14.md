...
Replace Guava caches with Caffeine to improve performance and reduce chance of deadlocks.

  Replacing Guava caches with [Caffeine](https://github.com/ben-manes/caffeine) brings
  two things. It reduces the chances of having the deadlock most likely caused by a
  [bug in the Linux kernel](https://github.com/torvalds/linux/commit/b0c29f79ecea0b6fbcefc999e70f2843ae8306db),
  and it [improves the cache performance](https://github.com/ben-manes/caffeine/wiki/Benchmarks).
...
* Upgrade jsinterop-annotations to 1.0.2
  ...
  This is a transient dependency of GWT and was missed in the previous
