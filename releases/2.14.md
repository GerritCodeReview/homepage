...
Download: **[2.14.9](https://gerrit-releases.storage.googleapis.com/gerrit-2.14.9.war)**
...
Documentation: **[2.14.9](https://gerrit-documentation.storage.googleapis.com/Documentation/2.14.9/index.html)**
...
### 2.14.10 *(in development)* {#2.14.10}
...
Simplify the configuration of Elasticsearch servers.
  ...
  This also fixes [Issue 9383](https://bugs.chromium.org/p/gerrit/issues/detail?id=9372)
