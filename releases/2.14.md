...
Open and Abandoned changes can now be deleted by admins and by users who have Delete Own Change
Permission.
...
* Added mariadb-connector-java

* Update jetty to 9.3.16.v20170120

* Update gson to 2.8.0

* Update gwtorm to 1.18

* Update gwt to 2.8.0

* Update bouncycastle to 1.56 (note that bouncycastle will no longer be stored in the lib folder, instead
  it is included in the gerrit war)
