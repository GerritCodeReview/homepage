...
* Made several improvments and additions to the documentation to help users
...
muted](https://gerrit-documentation.storage.googleapis.com/Documentation/2.15/intro-user.html#ignore)
...
* New [quickstart guide](https://gerrit-review.googlesource.com/Documentation/2.15/linux-quickstart.html)
  to install Gerrit on Linux
* New [About Gerrit](https://gerrit-review.googlesource.com/Documentation/2.15/#_about_gerrit)
  section that helps to introduce users to Gerrit
* New [Concepts](https://gerrit-review.googlesource.com/Documentation/2.15/#_concepts)
