...
Download: **[2.15](https://www.gerritcodereview.com/download/gerrit-2.15.war)**

Documentation: **[2.15](https://gerrit-documentation.storage.googleapis.com/Documentation/2.15/index.html)**
...
The only account data not stored in NoteDb proper is the reviewed flags, which
were moved to an external database in [2.13](2.13.md).
...
### 2.15.1 *(in development)* {#2.15.1}

* [Issue 8677](https://bugs.chromium.org/p/gerrit/issues/detail?id=8677):
Fix internal error when sending raw input to PUT and POST REST endpoints.
