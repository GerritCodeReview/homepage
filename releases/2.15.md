...
Download: **[2.15.2](https://www.gerritcodereview.com/download/gerrit-2.15.2.war)**
| [2.15.1](https://www.gerritcodereview.com/download/gerrit-2.15.1.war)
...
Note that the search operators for WIP and private changes (`is:wip` and
`is:private` respectively) will only work after reindexing to the new
index version has completed, either by online or offline reindex.
