...
"reviewed" flag, which was moved to an [extension
point](https://gerrit-documentation.storage.googleapis.com/Documentation/2.15/dev-plugins.html#account-patch-review-store).
The default implementation uses a standalone, dedicated local H2 database,
independent of the database used by ReviewDb.
