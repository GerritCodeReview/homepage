...
#### ‘value to long’ error in schema migration

As described in [Issue 4323]9https://bugs.chromium.org/p/gerrit/issues/detail?id=4323),
...
* (https://code.google.com/p/gerrit/issues/detail?id=3790[Issue 3790]:
