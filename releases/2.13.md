...
Download: **[2.13.6](https://gerrit-releases.storage.googleapis.com/gerrit-2.13.6.war)**
...
Documentation: **[2.13.6](https://gerrit-documentation.storage.googleapis.com/Documentation/2.13.6/index.html)**
...
* Fix deletion of all project watches when the `watch.config` file is the
  only file on the branch.
