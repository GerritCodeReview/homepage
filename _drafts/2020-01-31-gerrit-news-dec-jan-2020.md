...
Thomas Draebig (SAP), David Ostrovsky and Luca Milanesio (GerritForge) have been working
...
That includes the ability to have directly link to the build logs from the Gerrit change screen
...
We are all wishful to see Zuul running and taking over Jenkins for the Gerrit change
