...
This was also one of the main "goals" of the Gerrit project foundeer, Shawn Pearce: using
...
open to the idea to remove the local database and place it by the NoteDb
