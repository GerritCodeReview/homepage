...
[LM] provided an update on the transactionality issue, mentioning that Dani is tackling
...
## JJ and Git Butler Integration with Gerrit
...
more suited for advanced users, while Git Butler is for everyone, but noted that Git
Butler is a commercial product, whereas JJ is completely open source.
