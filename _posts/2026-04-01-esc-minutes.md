...
2. **Content Moderation:**
    * **Project Leadership:** Initiate discussions with internal trust teams at Google to
    ...
    Google.
    * **Engineering Team:**: Review [proposed change](https://gerrit-review.googlesource.com/c/gerrit/+/569641), which introduced the dedicated global Delete Comment capability for removing comments and change messages.
...
4. **Java 25 Migration:**
    ...
    * **Engineering Team:** Add a new Jenkins job on the `master` branch that enforces Java 21 source and target compatibility, failing if the codebase inadvertently moves to Java 25.