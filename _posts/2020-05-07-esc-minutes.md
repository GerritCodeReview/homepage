...
of his type, amongst the general shortlist of the top 100 plugins for Gerrit.
...
Ben Rholfs agreed to start validating PolyGerrit in v3.2 and master using Chrome 80. Existing stable
...
* [Issue 10126 - A better way to prevent spam, or report spammers](http://bugs.chromium.org/p/gerrit/issues/detail?id=10126)
  ...
  and Ben Rohlfs would check internally if it would be possible to expose a button on the Gerrit UI for it.
