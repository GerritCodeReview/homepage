...
[list]: https://bugs.chromium.org/p/gerrit/issues/list
...
- *Submitted*: a fix has been submitted to a stable branch of the
...
### PolyGerrit
The new web interface built in Polymer.  Issues in this compontent
are actively managed by Googlers involved in the daily development
efforts.
