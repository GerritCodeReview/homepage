...
#### KR: Allow to deploy Gerrit UI as JGit Server as separate services and indepenent

#### KR: Enable other Gerrit review UIs on top of JGit Server (e.g. pull-requests)
