...
Gerrit Code Review is an OpenSource project, which means that the people
...
community, therefore there **ARE NOT guaranteed SLA (Service Level Agreement)**
...
| Severity | Description                                                 | Aimed response time
|----------|-------------------------------------------------------------|-------------------
