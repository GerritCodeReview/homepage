...
Download: **[3.4.5](https://gerrit-releases.storage.googleapis.com/gerrit-3.4.5.war)**
...
Documentation: **[3.4.5](https://gerrit-documentation.storage.googleapis.com/Documentation/3.4.5/index.html)**
...
* Security Fixes
  ...
  * [Issue 16054](https://crbug.com/gerrit/16054):
  ...
  using the create branch REST-API
    ...
    access to any SHA1 or refs, including the ones that he would
...
* New features
  ...
  * [Change 343096](https://gerrit-review.googlesource.com/343096):
  Introduce `index.paginationType` configuration for speeding up
  query pagination
