---
title: "Gerrit 3.4.0-rc0 release (in development)"
permalink: 3.4.html
hide_sidebar: true
hide_navtoggle: true
toc: true
...
pre default. There is still option to switch to using JCraft JSch client library.
...
### Discontinue ElasticSearch support

There is a plan to drop ElasticSearch support in Gerrit because of SSPL licensing
in future releases.
