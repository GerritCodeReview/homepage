...
Download: **[3.4.7](https://gerrit-releases.storage.googleapis.com/gerrit-3.4.7.war)**
...
Documentation: **[3.4.7](https://gerrit-documentation.storage.googleapis.com/Documentation/3.4.7/index.html)**
...
* Breaking changes
  ...
  * [Issue 16379](https://gerrit-review.googlesource.com/c/gerrit/+/350456):
...
* Performance Fixes
  ...
  * [Change 349895](https://gerrit-review.googlesource.com/c/gerrit/+/349895):
  Add AndCardinalPredicate and OrCardinalPredicate
    ...
    `HasCardinality#getCardinality()`. `AndCardinalPredicate` will return
...
* Bug Fixes
  ...
  * [Issue 16182](https://gerrit-review.googlesource.com/c/gerrit/+/343074):
  Reintroduce the Change-Id footer in change screen

    The change I971bc62bacc61 has removed the Change-Id footer
    of the old-style change summary, without introducing any alternative
    way of displaying the Change-Id value when a project does not require
    Change-Ids in commit messages of new changes.
    The push of new changes without a client-side generated Change-Id
    is still supported but deprecated but it should still be supported until
    is completely removed.

  * [Issue 16322](https://gerrit-review.googlesource.com/c/gerrit/+/348314):
  Limit the number of changes that can be submitted together
    ...
    Navigating over 32767 changes up to some unrealistic number (for mono-repo)
    would have generated a significant CPU and memory overload and still not
    resulted in a submittable chain of changes.

  * [Issue 10168](https://gerrit-review.googlesource.com/c/gerrit/+/348054):
  Fix HTTP 404 when browsing tags on Gitweb

    The Gitweb links to tags have been broken since Gerrit v2.14.10
    following the introduction of tag links with If431ad869.
  ...
  * [Issue 15997](https://gerrit-review.googlesource.com/c/gerrit/+/342469):
