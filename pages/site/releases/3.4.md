...
* Breaking changes
  ...
  * [Change 344300](https://gerrit-review.googlesource.com/344300):
  Add missing return values in MetricMaker's `newCallMetric` and
  `newConstantMetric`
    ...
    The method signature is now aligned, however, all plugins that were
    registering callback or constant metrics would need to be rebuilt from
    source.
