...
3. Revert the index changes
   * Revert to a backup of the index files taken before the v3.4.x upgrade.
   * Alternatively you can perform a complete reindex, although this may take considerable
     time on large sites.
     ```sh
     java -jar gerrit.war reindex --index changes -d site_path
     ```
