...
Download: **[2.15.12](https://gerrit-releases.storage.googleapis.com/gerrit-2.15.12.war)**
...
Documentation: **[2.15.12](https://gerrit-documentation.storage.googleapis.com/Documentation/2.15.12/index.html)**
...
### New limit on number of commits received

A limit on the number of commits received is added. The motivation is to
...
* Update JGit to 4.9.0.201710071750-r (updated to 4.9.9.201903122025-r in 2.15.12)
