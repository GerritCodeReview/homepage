...
* [Change 579641](https://gerrit-review.googlesource.com/c/gerrit/+/579641):
Remove UiFeature__enable_ai_chat experiment

  The AI Chat button is now controlled by backend revision actions. It is
  only rendered when the dedicated ai-review-provider plugin is installed
  and the user has access to the AI review action.
