...
Download: **[3.14.0-rc6](https://gerrit-releases.storage.googleapis.com/gerrit-3.14.0-rc6.war)**

Documentation: **[3.14.0-rc6](https://gerrit-documentation.storage.googleapis.com/Documentation/3.14.0/index.html)**
...
* [Issue 500769405](https://issues.gerritcodereview.com/issues/500769405),
  [Change 574541](https://gerrit-review.googlesource.com/c/gerrit/+/574541):
  Fix a bug where users without the `aiReview` permission could still see the
  AI review action. Gerrit now reports the AI review permission correctly in
  the revision actions response.
