...
Enable hybrid modules to start migration to bzlmod
  ...
  its external dependencies. The update has a ripple effect on all the plugins
  that required additional dependencies, which would need to be ported to
  bzlmod for being built with Gerrit.
