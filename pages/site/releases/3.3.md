...
Download: **[3.3.10](https://gerrit-releases.storage.googleapis.com/gerrit-3.3.10.war)**
...
Documentation: **[3.3.10](https://gerrit-documentation.storage.googleapis.com/Documentation/3.3.10/index.html)**
...
* Security Fixes
  ...
  * [Issue 15563](https://crbug.com/gerrit/15563):
  DoS vulnerability with unlimited changes query

    Restrict by default the ability to search changes by anonymous users, defining
    a limit of 100 pages and disabling the possibility to skip limits.
    The `no-limit` option for changes queries is ignored if the incoming user
    is not authentication or otherwise anonymous.
...
* Bug Fixes
  ...
  * [Issue 15500](https://crbug.com/gerrit/15500):
  java.util.IllegalFormatArgumentIndexException on Java 17
