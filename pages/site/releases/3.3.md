...
* [Issue 13670](https://bugs.chromium.org/p/gerrit/issues/detail?id=13670);
  ...
  As an example, this setting is useful when swapping the default H2
  persistent cache implementation for the [chronicle-map implementation](https://gerrit.googlesource.com/modules/cache-chroniclemap/+/refs/heads/stable-3.3)
  since the latter is bound to open more file descriptors, mostly due to its
