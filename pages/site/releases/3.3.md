...
**NOTE**: When setting The schema version 184 is tolerated by the Gerrit v3.2 because the group-id
...
2. Bump the schema version back to 183 (see [git hash-object](https://git-scm.com/docs/git-hash-object))
3. Revert the 184 migration on All-Users.git, refname `refs/meta/group-names`
