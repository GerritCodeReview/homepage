...
### 3.8.7 (In Development)

* Enhancements

  * [Change 430799](https://gerrit-review.googlesource.com/430799):
  Set the content type when handling `gr-app.js` to avoid a warning in the browser console.
