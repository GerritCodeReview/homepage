...
Documentation: **[3.8.6](https://gerrit-documentation.storage.googleapis.com/Documentation/3.8.6/index.html)**
...
* JGit changes
  ...
  * [Change 433257](https://gerrit-review.googlesource.com/c/gerrit/+/433257):
    Update JGit to cfdfb01f4

    ```shell
    git log --no-merges --format=oneline 76ce6d91a..cfdfb01f4
    ```
  ...
  * [Change 432237](https://gerrit-review.googlesource.com/c/gerrit/+/432237):
    Update JGit to 76ce6d91a

    ```shell
    git log --no-merges --format=oneline c0b415fb0..76ce6d91a
    ```
