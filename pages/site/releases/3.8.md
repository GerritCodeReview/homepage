...
> **NOTE**: The repository refs are kept in the thread local storage and are not
> evicted upon updates on the underlying repository, causing the processing of
> ref-updates based on stale ref directory data.
