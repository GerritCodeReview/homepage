...
4. Reindex
   ...
   * If you are upgrading from a 3.7, run reindex of `changes`:
...
* [Change 351756](https://gerrit-review.googlesource.com/351756):
Implemented new auto theme mode

  The theme is automatically changed to light/dark based on your OS preference.
  You can change the theme in user's preferences.

* [Change 351754](https://gerrit-review.googlesource.com/351754):
Added new copy links

  copy links is now available in the dropdown next to the change number with
  keyboard shortcuts or a button to quickly copy the format that you prefer for
  your snippets.
