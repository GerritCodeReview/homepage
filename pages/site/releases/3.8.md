...
> **NOTE**: The repository refs snapshot is kept in the thread local storage
> for duration of the incoming request and  on the underlying repository,
> risking to cause the processing of ref-updates based on a potentially
> stale ref value. This may result in temporary or permanent repository
> inconsistencies, see [Issue 309098227](https://issues.gerritcodereview.com/issues/309098227).
