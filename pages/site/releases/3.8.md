...
Download: **[3.8.3](https://gerrit-releases.storage.googleapis.com/gerrit-3.8.3.war)**
...
Documentation: **[3.8.3](https://gerrit-documentation.storage.googleapis.com/Documentation/3.8.3/index.html)**
...
* Bug Fixes
  ...
  * [Change 395016](https://gerrit-review.googlesource.com/c/gerrit/+/395016)
  Fixed NPE when submitting changes.
    ...
    Fixed MagicLabelPredicates.ignoresUploaderApprovals throwing NPE if account is null
