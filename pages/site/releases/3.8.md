...
* Bug Fixes
  * [Issue 338826950](https://issues.gerritcodereview.com/issues/338826950) Fix NPE during git clone
...
* New Features
   * [Change 424957](https://gerrit-review.googlesource.com/c/gerrit/+/424957) Emails notifications for comments now mentions who owns the change.
   When receiving the email, knowing the change owner lets the receiver
   knows it is one of their change and might refine reviewing priority for
   some people.
