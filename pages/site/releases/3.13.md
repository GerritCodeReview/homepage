...
> **NOTE**: Groups references in projects ACLs cannot be deleted.

### Project screen for Submit Requirements

The Submit Requirements associated with a Project are now accessible through
a dedicated screen, which allows to:

- List the Submit Requirements enabled for a project
- Create a new Submit Requirement directly to a project
- Request the creation of a new Submit Requirement as a new Change

The screen uses brand-new REST API that also allows the full automation
of the listing, creation and edit of Submit Requirements via scripting.
...
the valid ones. See [Issue 440670261](https://issues.gerritcodereview.com/issues/440670261)
for more details.
