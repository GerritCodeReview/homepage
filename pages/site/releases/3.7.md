...
Downgrade to Gerrit v3.6.x release is not possible out of the box, but requires the following manual steps:
...
Because of the additional manual steps, extra care should be taken when
planning, testing and executing such rollback.
