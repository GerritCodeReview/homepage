...
Download: **[3.7.0-rc2](https://gerrit-releases.storage.googleapis.com/gerrit-3.7.0-rc2.war)**

Documentation: **[3.7.0-rc2](https://gerrit-documentation.storage.googleapis.com/Documentation/3.7.0/index.html)**
...
Comments and checks accepts and render the full markdown syntax, allowign richer interaction
and communication between authors and reviewers.

### Import of Projects and Chages from other Gerrit servers
