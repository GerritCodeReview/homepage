...
1. Configure the [`gerrit.importedServerId`](https://gerrit-documentation.storage.googleapis.com/Documentation/3.7.0/config-gerrit.html#gerrit.importedServerId)
   ...
   of the Gerrit servers from where the project changes are coming from.

2. Identification of the accounts involved in the project changes to import and creation
   of the [`imported` external-ids]() in the `All-Users.git` repository.
