...
Download: **[3.7.1](https://gerrit-releases.storage.googleapis.com/gerrit-3.7.1.war)**
| [3.7.0](https://gerrit-releases.storage.googleapis.com/gerrit-3.7.0.war)

Documentation: **[3.7.1](https://gerrit-documentation.storage.googleapis.com/Documentation/3.7.1/index.html)**
...
* New features
  ...
  * [Change 351774](https://gerrit-review.googlesource.com/c/gerrit/+/351774):
  New copy links in the dropdown next to the change number.
    ...
    New new copy links and keyboard shortcuts or a button is added to the dropdown
