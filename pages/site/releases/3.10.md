...
It's now possible to have a plugin generation suggested fixes directly in the
...
So far querying changes using the `changes:` predicate did not
allow to use the `project~changeNumber` format. However, since
I32a3131b15948f2ceda32dddcd3c5038d0f89dfd this is the default ID
...
### Update author and commiter from the UI
