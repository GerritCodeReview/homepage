...
Download: **[3.10.1](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.1.war)**
| [3.10.0](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.0.war)

Documentation: **[3.10.1](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.1/index.html)**
...
* Enhancements
  ...
  * [Change 436937](https://gerrit-review.googlesource.com/c/gerrit/+/436937):
  Add display names for email messageClass.
    ...
    A String containing the messageClass display text can now be used in Soy templates.
...
* Bug Fixes
  ...
  * [Issue 359613387](https://gerrit-review.googlesource.com/c/gerrit/+/435097):
  Fix download of GJF for versions <= `1.7`
    ...
    Fix broken download links for `google-java-format`
