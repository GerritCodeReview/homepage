...
Download: **[3.10.0-rc6](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.0-rc6.war)**

Documentation: **[3.10.0-rc6](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.0/index.html)**
...
Currently plugins are loaded in alphabetical order, however, in some complex
Gerrit deployments, the order in which plugins are enabled during startup time matters.
I.e. When in a multi-site setup, if multi-site plugin is loaded before
pull-replication, then some events could not be replicated as pull-replication
won't be ready to consume the events generated by multi-site. This will effectively
result in those events going lost.
...
* [Issue 335613081](https://crbug.com/gerrit/335613081): Fix the saving and rendering
of diff-preferences not having an immediate impact on the UI

* [Change 421257](https://gerrit-review.googlesource.com/421257): Fix redirection to the
target page upon a successful login

* [Issue 295374158](https://crbug.com/gerrit/295374158): Fix UI issue where the focus
was unpredictably lost while typing a draft comment.

* [Change 420337](https://gerrit-review.googlesource.com/420337): Fix the login button
disappearing when the page title was big enough in the navigation bar.
