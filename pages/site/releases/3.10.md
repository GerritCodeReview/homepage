...
Download: **[3.10.9](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.9.war)**
| [3.10.8](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.8.war)
| [3.10.7](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.7.war)
| [3.10.6](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.6.war)
| [3.10.5](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.5.war)
| [3.10.4](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.4.war)
| [3.10.3](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.3.war)
...
Documentation: **[3.10.9](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.9/index.html)**
| [3.10.8](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.8/index.html)
| [3.10.7](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.7/index.html)
| [3.10.6](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.6/index.html)
| [3.10.5](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.5/index.html)
| [3.10.4](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.4/index.html)
| [3.10.3](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.3/index.html)
...
* [Issue 470114241](https://issues.gerritcodereview.com/issues/470114241): Performance regression when accessing packfiles
  ...
  v3.10.4 bumped JGit to d5cc102e7 which introduced the [JGit Change 1205639](https://eclipse.gerrithub.io/c/eclipse-jgit/jgit/+/1205639)
  which has introduced a `synchronized` block around the access to the
...
* [Deprecated robot-comments](#allow-fixes-in-human-comments-via-rest-api)
...
* Bug Fixes
  ...
  * [Issue 456521736](https://issues.gerritcodereview.com/issues/456521736):
    Avoid _"change N missing from ChangeSet[][]"_ error when submitting a change with a stale index entry.
...
* Bug Fixes
  ...
  * [Issue 437141693](https://issues.gerritcodereview.com/issues/437141693):
    Fix an issue introduced in Gerrit 3.10.7 where plugins' persisted caches weren't persisted anymore.
...
* Plugins
  * [Change 473229](https://gerrit-review.googlesource.com/c/gerrit/+/473229)
    ...
    * b00a2c28e (HEAD, origin/master, origin/HEAD) Disable retries if maxAllowedRetries is 0
  ...
  * [Change 480184](http://gerrit-review.googlesource.com/c/plugins/replication/+/480184)
    Update plugins/replication from branch 'stable-3.10'
          to 5be3cc55304ebdef853fb43ec184a51f59fdf07f
    ...
    * 5be3cc553 Make excludedRefsPattern() to return an empty list by default
    * f01716cb2 Do not push deletes for refs configured to be skipped
    * 4161f9499 Add a remote config to exclude replicating desired refs
    * 28ea10317 Auto-format source code using gjf
...
* Plugin changes
  ...
  * `codemirror-editor` plugin:
    ...
    * [Change 462843](https://gerrit-review.googlesource.com/462843):
...
* Bug fixes
  ...
  * [Issue 388863156](https://issues.gerritcodereview.com/issues/388863156):
  Fix OutOfScopeException reported in `error_log` when reloading plugins via REST-API

  * [Issue 383513682](https://issues.gerritcodereview.com/issues/383513682):
  Fix Protobuf deserialization of project config with empty Group UUIDs

  * [Change 445421](https://gerrit-review.googlesource.com/c/gerrit/+/445421):
  Fix _"undefined is not an object (evaluating 'navigator.serviceWorker.controller')"_
  in Gerrit UX
