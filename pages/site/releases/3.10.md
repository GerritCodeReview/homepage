...
Download: **[3.10.7](https://gerrit-releases.storage.googleapis.com/gerrit-3.10.7.war)**
...
Documentation: **[3.10.7](http://gerrit-documentation.storage.googleapis.com/Documentation/3.10.7/index.html)**
...
* Bug Fixes
  ...
  * [Issue 437141693](https://issues.gerritcodereview.com/issues/437141693):
  ...
  a7bc50edd6e reverts 6f8308fd2b6 which introduced this issue.
  ...
  * [Change 498181](https://gerrit-review.googlesource.com/c/gerrit/+/498181)
  ...
  group names. These where failing because the group member expansion was being
  blocked by permission checks.

  Groups with external subgroups were unaffected because they use
  OwnerinPredicate which evaluates membership dynamically at match time using
  the actual change owner's context.

  * [Issue 435230894](https://issues.gerritcodereview.com/issues/435230894)
  Fix instances where changes sequence ref is rewound

  Introduce NonIncrementingSequenceException to enforce that sequence
  values stored in refs must be strictly increasing. This change serves
  as a safety net for rare scenarios on NFS where an outdated value
  might be retrieved.

* Frontend changes
  * [Issue 433273946](https://issues.gerritcodereview.com/issues/433273946)
   gr-edit-controls: Fix issue with autocomplete on mobile
