...
* Bug Fixes
  ...
  * [Issue 439859126](https://issues.gerritcodereview.com/issues/439859126):
    Return `HTTP 401` for any incoming authentication request with a password longer than `72` chars

      Fixed password validation to explicitly fail when a password is 72 characters or longer,
