...
endpoint. Please see more details [here](https://gerrit-review.googlesource.com/Documentation/rest-api-config.html#list-experiments)

### Made index management more accessible
A number of rest endpoints have been added to simplify management and observability of Gerrit indexes.
It's now possible to:
- [List indexes](https://gerrit-review.googlesource.com/Documentation/rest-api-config.html#list-indexes)
- [Get a index](https://gerrit-review.googlesource.com/Documentation/rest-api-config.html#_get_index), along side information on it's version.
- [Create snapshots](https://gerrit-review.googlesource.com/Documentation/rest-api-config.html#snapshot-index) of the index. These can then be used as backups of the index.
- [Re-index an index version](https://gerrit-review.googlesource.com/Documentation/rest-api-config.html#_reindex_an_index_version). It is also possible to specify weather to re-use up-to-date index documents.
...
- Gerrit no longer send emails to everyone when additional reviewers or CCs are added. Please note, this is also a breaking change, see more details on the change, [Change 400822](https://gerrit-review.googlesource.com/400822)

- [Issue 262017722](https://gerrit-review.googlesource.com/q/bug:262017722):
Only add owner and uploader to the attention set if the label is copied over to the latest patchset, avoiding emails for votes on older patchsets that don't affect the latest one.
The reason for the user being in the attention set is also automatically updated.

* - Stop always cc'ing all "reviewers by email", as otherwise they receive more emails than intended.
[Change 409733](https://gerrit-review.googlesource.com/409733)

### Support project~changeNumber when querying for changes

This renforces the concept that `project~changeNumber` should be the Id to use when trying to unique identify changes.
This should be preferred t0 `project~branch~changeId` as this can theoretically contain duplicates.
* [Change 399319](https://gerrit-review.googlesource.com/399319)

### Configurable H2 cache pruning
Schedule of cache pruning of H2 caches is now configurable. This means that it doesn't necessarily need to run on startup, therefore improving
Gerrit startup times.
Find more information in the [docs](https://gerrit-review.googlesource.com/Documentation/config-gerrit.html#cachePruning).
...
### Native log rotation
So far Gerrit admins have always needed to rely on external tools to effectively rotate logs, now this feature is brought within Gerrit itself and made easily configurable.
...
* [Issue 325070428](https://crbug.com/gerrit/325070428) Fixed PostReview to not execute the submit rules twice when the SUBMIT_REQUIREMENTS or SUBMITTABLE options were requested
...
* [Change 407417](https://gerrit-review.googlesource.com/407417) Branch links in change metadata now ignore status // TODO, Link in change details doesn't contain status anymore
* [Change 404717](https://gerrit-review.googlesource.com/404717)Deprecate review command without project argument
* [Change 412438](https://gerrit-review.googlesource.com/412438) Fix behavior of rules.enable config to disable prolog // I think?
* [Issue 325070428](https://crbug.com/gerrit/325070428) Added new current_revision_number field to ChangeInfo that contains the current patch set number
...
* [Issue 320946495](https://crbug.com/gerrit/320946495) Fail review command if multiple changes are selected
* [Issue 320946495](https://crbug.com/gerrit/320946495) Use project in review command
...
* [Issue 240676565](https://crbug.com/gerrit/240676565) Reviewer updates for reviewers by email are returned in change details
* [Issue 326096919](https://crbug.com/gerrit/326096919) Fixed internal server error when posting a review with a ReviewerInput that
...
* [Issue 312899496](https://gerrit-review.googlesource.com/q/bug:312899496) Reworked the project config documentation page
* [Issue 312890385](https://gerrit-review.googlesource.com/q/bug:312890385) Improved the submit requirements documentation
...
* [Issue 313411537](https://gerrit-review.googlesource.com/q/bug:313411537) Improve docs around submit requirements and access rights
...
* [Issue 320820903](https://gerrit-review.googlesource.com/q/bug:320820903) Update docs on Project ownership.
...
* [Issue 319778767,](https://crbug.com/gerrit/319778767,) Update commons-compress to 1.25.0
* [Change 399557](https://gerrit-review.googlesource.com/399557) Update ch.qos.reload4j:reload4j to 1.2.25
* [Issue 317782004](https://crbug.com/gerrit/317782004) Update org.apache.httpcomponents:httpcore to 4.4.16
* [Issue 317790747](https://crbug.com/gerrit/317790747) Update com.google.auto.value:auto-value to 1.10.4
* [Issue 317782000](https://crbug.com/gerrit/317782000) Update org.apache.httpcomponents:httpclient to 4.5.14
...
## Frontend changes
* [Issue 315957653](https://crbug.com/gerrit/315957653) account-chip hover-card shows correct email for author and committer
...
UI supports updating commit message using a registered secondary email
...
* [Issue 40015337](https://crbug.com/gerrit/40015337) Fix browser BACK button when going to plugin pages
...
* [Issue 40004507](https://crbug.com/gerrit/40004507) Added support for filtering branches/tags in plugins.
* [Issue 330574510](https://crbug.com/gerrit/330574510) Fix issue with gr-file-list-header not working correctly after writing a comment
