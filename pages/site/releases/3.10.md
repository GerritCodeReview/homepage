...
Release-Notes: Make cache pruning schedule configurable - NOTE, BY DEFAULT IT SEEMS ENABLED
...
Release-Notes: Allow fix-suggestions with human comments - Should change anything, just checking
