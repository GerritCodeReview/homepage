...
Download: **[2.13.13](https://gerrit-releases.storage.googleapis.com/gerrit-2.13.13.war)**
...
Documentation: **[2.13.13](https://gerrit-documentation.storage.googleapis.com/Documentation/2.13.13/index.html)**
...
Upgrade JGit to 4.5.7.201904xxxxx-r to fix regression in packfile list
handling.

 If `core.trustfolderstat` is set to `false`, an infinite loop can occur
 when an object is not found in the packfile.
