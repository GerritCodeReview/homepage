...
Download: **[3.0.6](https://gerrit-releases.storage.googleapis.com/gerrit-3.0.6.war)**
...
Documentation: **[3.0.6](https://gerrit-documentation.storage.googleapis.com/Documentation/3.0.6/index.html)**
...
* The `MessageOfTheDay`-extension point was removed.
  ...
  the `MessageOfTheDay`-extension point was removed. However, the UI provides
  the `banner`-entrypoint for plugins to add messages to the UI. Plugins that
  were previously using the `MessageOfTheDay`-extension point have to be adapted
  accordingly.
