...
* End-to-end Tests Improvements
  ...
  * Allow end-to-end tests to proportionnally scale on their expected execution times.
  ...
  * Allow scenarios to create and delete Gerrit changes alongside projects.
    ...
    that way. The latter currenty has [Issue 12693](https://bugs.chromium.org/p/gerrit/issues/detail?id=12693)
