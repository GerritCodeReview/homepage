...
* Breaking Changes
  ...
  * Elasticsearch: Support for [EOL versions](https://www.elastic.co/support/eol)
    6.6 and 6.7 is discontinued. Note also that the Elasticsearch 6 minor version
    used in Gerrit core was upgraded to `6.8.12`.
...
* End-to-end Tests Improvements
  ...
  * The redundant or unnecessary code constructs were removed.

  * The previously confusing variable names were refactored.
...
* Documentation Updates
  ...
  * Gerrit
  ...
  was added as a new documentation page.
