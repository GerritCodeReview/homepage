...
Download: **[3.0.11](https://gerrit-releases.storage.googleapis.com/gerrit-3.0.11.war)**
...
Documentation: **[3.0.11](https://gerrit-documentation.storage.googleapis.com/Documentation/3.0.11/index.html)**
...
* New permission `Toggle Work In Progress state`.

[Issue 10385](https://crbug.com/gerrit/10385):

  Allow to grant the `Toggle Work In Progress state` permission to arbitrary
  users using new permission to control who is able to flip the Work In Progress
  bit in addition to three different groups allowed to toggle Work In Progress
  state already: change owner, server administrators and project owners.
