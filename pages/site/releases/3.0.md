...
Download: **[3.0.2](https://gerrit-releases.storage.googleapis.com/gerrit-3.0.2.war)**
...
Documentation: **[3.0.2](https://gerrit-documentation.storage.googleapis.com/Documentation/3.0.2/index.html)**
...
* New Features
  ...
  * Allow plugins to specify a capability that users must have in order to
  view a plugin provided top menu item.
...
* Elasticsearch Updates
  ...
  * Update elasticsearch-rest-client to 7.3.2.
...
* Other fixes
  ...
  * [Issue 11246](https://bugs.chromium.org/p/gerrit/issues/detail?id=11246):
  Allow duplicate email addresses per user account.
