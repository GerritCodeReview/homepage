...
Download: **[3.0.3](https://gerrit-releases.storage.googleapis.com/gerrit-3.0.3.war)**
...
Documentation: **[3.0.3](https://gerrit-documentation.storage.googleapis.com/Documentation/3.0.3/index.html)**
...
* New Features
  ...
  * [Issue 11356](https://bugs.chromium.org/p/gerrit/issues/detail?id=11356):
  Allow to override autodetected Lucene index configuration.
    ...
    [`index.name.maxThreadCount`](http://gerrit-documentation.storage.googleapis.com/Documentation/3.0.3/config-gerrit.html#index.name.maxThreadCou>
    [`index.name.enableAutoIOThrottle`](http://gerrit-documentation.storage.googleapis.com/Documentation/3.0.3/config-gerrit.html#index.name.enable>
