...
Download: **[2.16-rc0](https://gerrit-releases.storage.googleapis.com/gerrit-2.16-rc0.war)**

Documentation: **[2.16-rc0](https://gerrit-documentation.storage.googleapis.com/Documentation/2.16-rc0/index.html)**
...
If you are migrating directly from a Gerrit version older than v2.15, you have
no other choice than regenerating all the indexes and migrating from
ReviewDb to NoteDb using an off-line process.

For more information about the off-line migration process to NoteDb,
refer to the [Gerrit Documentation.](https://gerrit-review.googlesource.com/Documentation/note-db.html#offline-migration)
