...
Download: **[2.16.1](https://gerrit-releases.storage.googleapis.com/gerrit-2.16.1.war)** | **[2.16](https://gerrit-releases.storage.googleapis.com/gerrit-2.16.war)**

Documentation: **[2.16.1](https://gerrit-documentation.storage.googleapis.com/Documentation/2.16.1/index.html)** | **[2.16](https://gerrit-documentation.storage.googleapis.com/Documentation/2.16/index.html)**
...
* [Issue 9768](https://bugs.chromium.org/p/gerrit/issues/detail?id=9768): Elasticsearch - Make the number of replicas and number of shards configurable
* [Issue 10144](https://bugs.chromium.org/p/gerrit/issues/detail?id=10144): Query - Fix visibleto:group predicate
* [Issue 10143](https://bugs.chromium.org/p/gerrit/issues/detail?id=10143): Fix ssh -p 29418 ${USER}@${IP} kill ${ID}
* [Issue 10132](https://bugs.chromium.org/p/gerrit/issues/detail?id=10132): Fix hooks plugin loading failure
* [Issue 10131](https://bugs.chromium.org/p/gerrit/issues/detail?id=10131): Fix reviewnotes plugin loading failure
* [Issue 10106](https://bugs.chromium.org/p/gerrit/issues/detail?id=10106): REST API - Fix update project rights
* [Issue 10038](https://bugs.chromium.org/p/gerrit/issues/detail?id=10038): Elasticsearch - Support v6.5.0
* [Issue 10021](https://bugs.chromium.org/p/gerrit/issues/detail?id=10021): Security - Disallow create project to execute arbitrary code on the client
* [Issue 10018](https://bugs.chromium.org/p/gerrit/issues/detail?id=10018): Upgrade - Fix upgrade schema when migrating from 2.13 to 2.16 with OracleDB
