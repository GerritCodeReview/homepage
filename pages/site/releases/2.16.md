...
Download: **[2.16.15](https://gerrit-releases.storage.googleapis.com/gerrit-2.16.15.war)**
...
Documentation: **[2.16.15](https://gerrit-documentation.storage.googleapis.com/Documentation/2.16.15/index.html)**
...
PolyGerrit no longer offically supports Internet Explorer. It never really worked.
...
* PolyGerrit UI Fixes
  ...
  * Add MessageOfTheDay-entries to ServerInfo.
    ...
    adds the messages registered to the MessageOfTheDay extension point to the
    ServerInfo, which can be fetched via Rest API.
    This allows accessing this information from a PolyGerrit UI element that
    displays messages registered with the MessageOfTheDay extension point.
...
* Other Changes
  ...
  * Update external Ids documentation with information on how to find the sha1
  of an external Id and how to show the corresponding change note.
