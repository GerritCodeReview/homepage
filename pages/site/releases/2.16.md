...
migrate changes from ReviewDb when upgrading to Gerrit v2.16 from either v2.14/v2.15.
...
**NOTE: ReviewDb is still technically available on Gerrit v2.16**. However, it is neither
actively maintained nor supported. Upgrade to NoteDb is mandatory, although not enforced during migration.
