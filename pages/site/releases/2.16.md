...
* Update JGit to 5.1.3.201810200350-r (Updated to 5.1.10.201908230655-r in 2.16.11)
...
* Upgrade JGit to 5.1.10.201908230655-r.
  ...
  * Includes various fixes related to file timestamp handling
  * Fixes `supportsAtomicCreateNewFile` default to true
  * Fixes non-deterministic hash of git archives

* [Issue 11235](https://bugs.chromium.org/p/gerrit/issues/detail?id=11235):
Use correct identity in `ls-user-refs` command.

* [Issue 11148](https://bugs.chromium.org/p/gerrit/issues/detail?id=11148):
Skip submit rules for closed changes during online index upgrade.
...
Bypass commit count when `skip-validation` option is used.

* [Issue 11348](https://bugs.chromium.org/p/gerrit/issues/detail?id=11348):
Log the progress of migration to NoteDb.

* [Issue 11325](https://bugs.chromium.org/p/gerrit/issues/detail?id=11325):
Don't bump the change's updated timestamp when removing all draft comments.
...
* PolyGerrit UI Fixes:
  ...
  * [Issue 11201](https://bugs.chromium.org/p/gerrit/issues/detail?id=11201):
  Allow empty label values.

  * [10166](https://bugs.chromium.org/p/gerrit/issues/detail?id=10166):
  Add shortcuts for dashboard and watched changes.
  ...
  * Fix gr-identities styles (TODO: better description of the fix, or just remove this entry)

  * [Issue 11028](https://bugs.chromium.org/p/gerrit/issues/detail?id=11028):
  Add support for "Link Another Identity".
