...
2.16.16 or earlier only support upgrading from 2.15.x. 2.16.17 or
newer support upgrading directly from 2.11.x or newer. Using the
latest 2.16.x version is recommended.
