...
Remove default bug tracker from feedbackUrl in PolyGerrit

* Default configuration change: increase the default sshd.threads from 2 to 4.
...
* Upgrade JGit to 5.1.10.201908230655-r.
  ...
  The JGit upgrade includes improvements on the Git racy-read released in
...
* [Issue 11348](https://bugs.chromium.org/p/gerrit/issues/detail?id=)
...
Do not updates change set modified date on ReviewDb when a user delete all its draft changes.

* Fix rebase change REST API returned status code.

  The rebase change REST API return 422 Unprocessable Entity, instead of 500 Internal Server Error,
...
* [Issue 11222](https://bugs.chromium.org/p/gerrit/issues/detail?id=):
...
* [Issue 11083](https://bugs.chromium.org/p/gerrit/issues/detail?id=11083):
Fix newRef in merge stack by push, change-merged event.
