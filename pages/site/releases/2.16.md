...
* Support binding a RestView to delete a missing resource through a brand-new [`DeleteViewBinder`](https://gerrit.googlesource.com/gerrit/+/stable-2.16/java/com/google/gerrit/extensions/restapi/DeleteViewBinder.java).
...
* New Api and REST endpoint to reindex a project on [`ProjectApi`](https://gerrit.googlesource.com/gerrit/+/stable-2.16/java/com/google/gerrit/extensions/api/projects/ProjectApi).
