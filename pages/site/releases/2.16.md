...
Download: **[2.16.8](https://gerrit-releases.storage.googleapis.com/gerrit-2.16.8.war)**
...
Documentation: **[2.16.8](https://gerrit-documentation.storage.googleapis.com/Documentation/2.16.8/index.html)**
...
Includes all fixes of [Gerrit v2.15.14](2.15.html#21514) plus the following fixes and improvements.
...
* [Issue 10664](https://bugs.chromium.org/p/gerrit/issues/detail?id=10664) MysqlAccountPatchReviewStore: Fix duplicate key detection

Retrieve the error code number from the SQL exception to
correctly detect a duplicate key error. 
