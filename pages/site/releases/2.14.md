...
Update jruby to 9.1.17 and asciidoctorj to 1.5.7.
  ...
  Since Bazel 0.16 the build is done with an embedded JRE using Java version
  9. The documentation build was using an older version of jruby that did
  not properly support Java 9.
