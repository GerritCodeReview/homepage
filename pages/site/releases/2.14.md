...
Emit a warning when starting Gerrit JVM without OOM protection.
...
colorization of remote output.
  ...
  In an upcoming version of git, the "warning" keyword will be highlighted
...
* Fix partially hidden plugin configuration in the GWT UI.
  ...
  value had more characters than the default number of characters displayed
  in the text box.
