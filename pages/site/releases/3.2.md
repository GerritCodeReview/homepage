...
Computing the mergability of changes is an expensive operation that can
...
More self-evident transitions from WIP state. "Mark as active" button added to change view.
