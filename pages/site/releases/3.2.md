...
* End-to-end Tests Improvements
  ...
  * New GC section in [jgit.config](https://gerrit-documentation.storage.googleapis.com/Documentation/3.2.5.1/config-gerrit.html#jgit-gc)
  with the details of the relevant JGit settings for tuning the repositories GC.

  * New Receive section in [jgit.config](https://gerrit-documentation.storage.googleapis.com/Documentation/3.2.5.1/config-gerrit.html#jgit-receive)
