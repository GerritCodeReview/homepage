...
Introduce concept of `instanceId` in Gerrit.
See [design doc](https://gerrit-review.googlesource.com/c/homepage/+/257972/26)
for more details.

* [Issue 12684](https://bugs.chromium.org/p/gerrit/issues/detail?id=12684):
configurability in `gerrit.config`.

* [Issue 12730](https://bugs.chromium.org/p/gerrit/issues/detail?id=12730):
exposure of `instanceId` to plugins.

* [Issue 12685](https://bugs.chromium.org/p/gerrit/issues/detail?id=12685):
propagation of `instanceId` in Events.
