...
**ref-update** for online-edits

Gerrit handles the lifecycle of online edits by oppuruntely creating, updating and removing
`refs/users/xx/xxxxxxx/edit-x/x` refs.

Change [393937](https://gerrit-review.googlesource.com/c/gerrit/+/393937) now ensures that the related `ref-updated`
stream events are also emitted accordingly.
