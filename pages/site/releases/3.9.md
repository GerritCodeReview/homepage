...
* [Change 390986](https://gerrit-review.googlesource.com/390986)
  ...
  Mockito framework was upgraded from `3.3.3` to `5.6.0`, hence if you have some custom plugins your test code might
  require some minor refactoring. Please refer to the
  mockito [documentation](https://javadoc.io/doc/org.mockito/mockito-core/5.6.0/org/mockito/Mockito.html)
