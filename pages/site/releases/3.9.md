...
Download: **[3.9.6](https://gerrit-releases.storage.googleapis.com/gerrit-3.9.6.war)**
...
Documentation: **[3.9.6](http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.6/index.html)**
...
* Bug Fixes
  ...
  * [Issue 368553867](https://gerrit-review.googlesource.com/438705):
  Fix support for a number of groups higher than the `index.maxTerms`
    ...
    Allow group queries to handle large numbers of groups by respecting index term limits,
    preventing errors in setups with many groups.

  * [Issue 360705824](https://gerrit-review.googlesource.com/c/gerrit/+/436677):
  Fix the ability to access changes that belong to project starting with a number.

     Fix redirects for changes URLs in projects starting with a number by refining regex handling
