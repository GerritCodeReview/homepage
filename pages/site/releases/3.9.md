...
Download: **[3.9.11](https://gerrit-releases.storage.googleapis.com/gerrit-3.9.11.war)**
| [3.9.10](https://gerrit-releases.storage.googleapis.com/gerrit-3.9.10.war)
| [3.9.9](https://gerrit-releases.storage.googleapis.com/gerrit-3.9.9.war)
| [3.9.8](https://gerrit-releases.storage.googleapis.com/gerrit-3.9.8.war)
| [3.9.7](https://gerrit-releases.storage.googleapis.com/gerrit-3.9.7.war)
...
Documentation: **[3.9.11](http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.11/index.html)**
| [3.9.10](http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.10/index.html)
| [3.9.9](http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.9/index.html)
| [3.9.8](http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.8/index.html)
| [3.9.7](http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.7/index.html)
...
* Plugin changes
  ...
  * Webhooks plugin updated to `9b5ae590085383567c3ea767cf1abca3021da060`:

  ```shell
  git log --oneline 1dc0a718839f8872a59c189da7243ee77a4fe782..9b5ae590085383567c3ea767cf1abca3021da060
  ```

  Notable changes are:
  ```shell
    9b5ae59 Add allowedUrlPattern global config
    913bbe8 Log when a webhook is created or updated
    d61540d Allow admins to limit timeouts, retries and retry interval
    0e69fc7 Log when post is unsuccessful and max retries exceed
  ```
...
* Plugin changes
  ...
  * Replication plugin updated to `5cfb07aa0e1e133a066ae81951b8e156d7dfd4e4`:

  ```shell
  git log --oneline 584aea1a8968a9162d78460422a285a87910f502..5cfb07aa0e1e133a066ae81951b8e156d7dfd4e4
  ```
