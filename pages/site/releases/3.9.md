...
[User suggest Edits](http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.1/user-suggest-edits.html)
was introduced in `3.7.2` as an experimental feature, disabled by default. With
Gerrit `3.9`, this feature is no longer experimental and _User Suggest Edits_
