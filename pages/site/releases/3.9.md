...
Download: **[3.9.2](https://gerrit-releases.storage.googleapis.com/gerrit-3.9.2.war)**
| [3.9.1](https://gerrit-releases.storage.googleapis.com/gerrit-3.9.1.war)

Documentation: **[3.9.2](http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.2/index.html)**
...
* Bug Fixes
  ...
  * [Issue 318079520](https://issues.gerritcodereview.com/issues/318079520)
  Fix comments rendering with imported changes
    ...
    Fixes a bug when comments posted on changes imported from another Gerrit instacne were not
    rendered in the UI.
...
* Dependency Updates
  ...
  * [Change 409781](https://gerrit-review.googlesource.com/409781)
  Added new minor improvements to download-commands plugin
