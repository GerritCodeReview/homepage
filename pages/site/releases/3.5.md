...
Download: **[3.5.1](https://gerrit-releases.storage.googleapis.com/gerrit-3.5.1.war)**
| [3.5.0.1](https://gerrit-releases.storage.googleapis.com/gerrit-3.5.0.1.war)

Documentation: **[3.5.1](https://gerrit-documentation.storage.googleapis.com/Documentation/3.5.1/index.html)**
...
### Known Issues
Known issues for the 3.5 release track can be found on the 
[issue tracker](https://bugs.chromium.org/p/gerrit/issues/list?q=label%3AKnownIssue%20Version%3D3.5&can=2).

Solved issues can be found in the Bug Fixes section for each release.
