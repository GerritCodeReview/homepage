...
is now available as parameter for changes's predicates and corresponds to any
...
avoiding the computation of a complexity of O(nˆ2).
...
To run off-line reindexing of the changes (optional when upgrading from v3.3.x
or later):
