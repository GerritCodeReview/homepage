...
* New features
  ...
  * [Change 347956](https://gerrit-review.googlesource.com/c/gerrit/+/347956):
    ...
    Before this change, cardinality of the IndexSource was always set to 1.
    This makes `AndSource` to choose IndexSource over other sources most of
    the time.
...
* Performance Fixes
  ...
  * [Change 350236](https://gerrit-review.googlesource.com/c/gerrit/+/350236)
    Optimized change visibility checking when the project is hidden
...
* Bug Fixes
  ...
  * [Change 350576](https://gerrit-review.googlesource.com/350576)
    ...
    failed for all changes in that project.
