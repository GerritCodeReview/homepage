...
Download: **[3.5.3](https://gerrit-releases.storage.googleapis.com/gerrit-3.5.3.war)**
...
Documentation: **[3.5.3](https://gerrit-documentation.storage.googleapis.com/Documentation/3.5.3/index.html)**
...
* Bug Fixes
  ...
  * Replication plugin
    ...
    * [Issue 15804](https://bugs.chromium.org/p/gerrit/issues/detail?id=15804);
      Do not retry replication when local repository not found
    * Ensure states are updated for canceled replication tasks

* Dependency Updates
  * [Issue 14861](https://bugs.chromium.org/p/gerrit/issues/detail?id=14861);
...
* [Issue 16182](https://bugs.chromium.org/p/gerrit/issues/detail?id=16182);
  Reintroduce the Change-Id footer in change screen

* [Issue 16322](https://bugs.chromium.org/p/gerrit/issues/detail?id=16322);
  Limit the number of changes that can be submitted together

* [Issue 13930](https://bugs.chromium.org/p/gerrit/issues/detail?id=13930);
  Register a default kex handler with the SshDaemon

* [Issue 10168](https://bugs.chromium.org/p/gerrit/issues/detail?id=10168);
...
* [Issue 15997](https://bugs.chromium.org/p/gerrit/issues/detail?id=15997);
