...
> Failing to run the `copy-approvals` tool would potentially leave changes with
> an incorrect approval score. It is not possible to run the tool in Gerrit v3.6.
...
7. Repeat steps 2. to 5. for all the other Gerrit servers.
