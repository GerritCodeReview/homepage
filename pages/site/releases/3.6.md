...
Download: **[3.6.5](https://gerrit-releases.storage.googleapis.com/gerrit-3.6.5.war)**
...
Documentation: **[3.6.5](https://gerrit-documentation.storage.googleapis.com/Documentation/3.6.5/index.html)**
...
* Bug Fixes
  ...
  * [Change 378558](https://gerrit-review.googlesource.com/c/gerrit/+/378558):
  Preserve refs order in the GitBatchRefUpdateEvent event
    ...
    fail because of the missing patchset. To make sure that refs order
    is preserved and backward compatibility is kept use LinkedHashSet
    instead of HashSet.
