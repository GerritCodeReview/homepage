...
* Breaking changes
  ...
  * [Issue 40015585](https://issues.gerritcodereview.com/issues/40015585):
  Breaking change: project based submetric name is sanitized with more rules than just changing `/` to `_`
    ...
    being escaped. Before "jgit_block_cache_cache_used_per_repository__var_gerrit_git_1eq_cordova_plugin_bluetoothle_git"
    after "jgit_block_cache_cache_used_per_repository__0x2F_var_0x2F_gerrit_0x2F_git_0x2F_1eq_0x2F_cordova_plugin_bluetoothle_0x2E_git".
