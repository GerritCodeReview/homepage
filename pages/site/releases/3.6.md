...
* Support for CentOS is dropped and the base image replaced by AlmaLinux
  ...
  [CentOS is EOL since December 2021](https://blog.centos.org/2020/12/future-is-centos-stream/) making
...
* Upgrade to gitiles v1.0.0
  ...
  list improvements in gitiles 1.0.0 since 0.4-1:
  ...
  - Fix relative link to image-size config.
  - Bump Java language level to Java 11
  - Adapt CSS for small screens
  - Redo branch redirect
  - List subdirectories at the top of the source tree
  - Add functionality to show notes
  - Add CSS to wrap ref names correctly
...
Add tab navigation for hovercards
...
Add changes and dashboard link to account hovercard.
