...
* [Issue 416196171](https://issues.gerritcodereview.com/issues/416196171):
Concurrent change insertion fails on ref-table-enabled repositories over NFS.

  Gerrit may encounter lock failures, when multiple ref-updates happen concurrently in a repository
...
* [Change 439226](https://gerrit-review.googlesource.com/c/gerrit/+/439226):
  ...
  The old configuration style is still honored but deprecated:
  ...
  subsection name provides namespace for configuring further periodic
  reindexers for other indexes.

  The default behaviour of starting periodic group reindexing on replicas
  is preserved for both the deprecated and the new configuration style.
