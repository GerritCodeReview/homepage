...
Download: **[3.12.7](https://gerrit-releases.storage.googleapis.com/gerrit-3.12.7.war)**
...
Documentation: **[3.12.7](https://gerrit-documentation.storage.googleapis.com/Documentation/3.12.7/index.html)**
...
Gerrit v3.12.x supports zero-downtime upgrade from Gerrit v3.11 and v3.10 when configured
using either
...
This is due to Lucene’s backward compatibility guarantees, which allow a Lucene
major version to read index formats generated by the previous (N-1) major version.

Since Gerrit v3.10 and v3.11 use Lucene 9.x and Gerrit 3.12 uses Lucene 10.x,
online upgrade is supported.

Upgrades from older versions (e.g. v3.9, which uses Lucene 8.x) are
not supported for zero-downtime upgrade.
...
3. Restore a backup of the previous Gerrit version indexes or rebuild the indexes offline
(i.e.: `java -jar bin/gerrit.war reindex`)
4. Init Gerrit
