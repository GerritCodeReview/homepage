...
Download: **[3.12.5](https://gerrit-releases.storage.googleapis.com/gerrit-3.12.5.war)**
...
Documentation: **[3.12.5](https://gerrit-documentation.storage.googleapis.com/Documentation/3.12.5/index.html)**
...
* [Change 451223](https://gerrit-review.googlesource.com/c/gerrit/+/451223):
  Added a new [MigrateLabelFunctions](https://gerrit-documentation.storage.googleapis.com
  /Documentation/3.12.5/pgm-MigrateLabelFunctions.html) site program for
  helping with the migration from label functions to Submit Requirements.
