...
* [Change ](https://gerrit-review.googlesource.com/c/gerrit/+/)
  Assign TRACE_ID for every request

* [Change ](https://gerrit-review.googlesource.com/c/gerrit/+/)
  Assign and log TRACE_ID for each git-over-ssh request

* [Change ](https://gerrit-review.googlesource.com/c/gerrit/+/)
  Add TRACE_ID to the httpd_log entries

* [Change ](https://gerrit-review.googlesource.com/c/gerrit/+/)
  Add TRACE_ID to the sshd_log entries

* [Change ](https://gerrit-review.googlesource.com/c/gerrit/+/)
  Add base url to service-worker url

* [Change ](https://gerrit-review.googlesource.com/c/gerrit/+/)
  Add cache endpoints to internal gerrit API client
