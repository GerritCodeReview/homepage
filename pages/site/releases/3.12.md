...
Download: **[3.12.8](https://gerrit-releases.storage.googleapis.com/gerrit-3.12.8.war)**
...
Documentation: **[3.12.8](https://gerrit-documentation.storage.googleapis.com/Documentation/3.12.8/index.html)**
...
Gerrit 3.12 now consumes JGit directly from the stable-7.5 branch.

The [previous release note](#3128) warned that Gerrit stable-3.12 could
not use JGit stable-7.5 and that users upgrading from stable-3.10 or
stable-3.11 would miss some JGit fixes. That limitation has been lifted.

#### JGit Changes

  ```shell
  git log --no-merges --oneline bb309748c..94fe3e89f
  ```

c2188c2a0 (origin/stable-7.4, stable-7.4) junit.http: Extract AppServerBase to dedupe the EE8 AppServer overlay
fbf29d88c Bazel: Add EE8 servlet test targets
6416c9f54 Bazel: Add EE8 servlet bridge targets
d14bd3b78 Bazel: Rename //lib:servlet-api to //lib:jakarta-servlet-api
f07b8fbe8 Bazel: format build files with buildifier
a14a4be39 Log loose ref deletion during ref cleanup
f2c3bdde6 (origin/stable-6.10, stable-6.10) Document JGit receive command size options
...
1ac5210cb TestProtocolTest: Cover additional fetch edge cases
189b33dcb FetchProcess: Report lock failure when destination ref changes
5b298ebe2 Add regression test on non-forced fetch and local updates
804e29be9 RefDirectory#refreshPathToLooseRef: also refresh loose ref itself
0db191381 Prepare 7.5.1-SNAPSHOT builds
402b0dd5c (tag: v7.5.0.202512021534-r) JGit v7.5.0.202512021534-r
34f169fa8 [ignore patterns] Backslash is a general escape
ffebbe7f4 Prepare 7.5.0-SNAPSHOT builds
81c15d41b (tag: v7.5.0.202511251519-rc1) JGit v7.5.0.202511251519-rc1
d0a524206 Do not always refresh packed-refs during ref updates
bb626255e Update Maven plugins
4158c2165 Update org.eclipse.jdt:ecj to 3.43.0
8cf66ce66 Update plexus-compiler to 2.16.0
6de21adff Update org.tukaani:xz to 1.11
b35f1b4a5 chore: Add sbom generation and upload workflow
780eceebd Prepare 7.5.0-SNAPSHOT builds
3bcf880cb (tag: v7.5.0.202511181624-m3) JGit v7.5.0.202511181624-m3
98594883d Update jetty to 12.1.4
a0ebfbe4d Update commons-lang3 to 3.20.0
2d39bfd38 Update bytebuddy to 1.18.1
07f585930 Silence non-externalized String warning
1ecc2d128 Document empty blocks
9bfb25807 BlameRegionMerger: externalize error message
f079409a4 Remove unnecessary semicolon
90feb21a5 MidxPackList: Methods to find the top midx and uncovered packs
5df4dcae3 Update commons-codec:commons-codec to 1.20.0
772c72092 Update commons-io:commons-io to 2.21.0
3a5b03c7b HttpConnection: add missing @since tag
8b23132d5 Avoid reading packed-refs concurrently sometimes
39409b6c0 Improve flaky InterruptTimerTests
d407865f6 Improve the README
240022be2 LfsPrePushHook: recognize 201 as successful response from LFS server
9997280e1 Revert "PackList: keep the list of unused midxs"
d782cc915 DfsGarbageCollector: Ignore midxs, commitPack() takes care of them
98f45b403 DfsGarbageCollectorTest: Assert there are not midxs in the db
b59a995d2 DfsObjDatabase: delete affected midxs when covered packs are deleted
a1d4b0059 [debug logging] Escape control characters other than TAB, CR, or LF
a678a5bc2 Refine time unit parsing to throw exception on invalid values
c866d9d28 [ssh] Simplify code
82204b94d PackList: keep the list of unused midxs
cee7ea6f5 DfsObjDatabase: Move midx pack mangling to getPacks()
44aac730c Prepare 7.5.0-SNAPSHOT builds
735596c22 (tag: v7.5.0.202510290248-m2) JGit v7.5.0.202510290248-m2
...
837a3c36e (origin/stable-6.2) Disable MergeToolTest#testEmptyToolName
fd7966d9e Fix hamcrest version to 3.0.0 in target platform
7aeb9b147 Add InterruptTimer Tests
66b55e568 Update slf4j to 2.0.17
877f9900c Update org.hamcrest to 3.0.0
d4e855882 DfsPackFile: asObjectIdSet() when only inclusion is needed.
dd4a19442 DfsObjDatabase: read reftables from midx covered packs
5424255f0 Update jetty to 12.1.3
...
d3429a62a (origin/stable-5.13) Allow to discover bitmap on disk created after the packfile
6225a7969 DfsPackCompactor: add toPrune method
4dccc412e MidxPackList: Helper to get packs/midx and overlaps between them
e6ba54be4 Prepare 7.5.0-SNAPSHOT builds
3513e75de (tag: v7.5.0.202510071400-m1) JGit v7.5.0.202510071400-m1
03a986274 Prepare 5.13.6-SNAPSHOT builds
9f8511be4 (tag: v5.13.5.202508271544-r) JGit v5.13.5.202508271544-r
4f56e7ee3 Remove resolver option from target-platform-configuration
3d9bca809 Add missing release property to maven build
14ba7db79 Suppress API errors for minor API changes in service releases
37443ffe0 Remove unnecessary casts
