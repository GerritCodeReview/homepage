...
Download: **[3.12.1](https://gerrit-releases.storage.googleapis.com/gerrit-3.12.1.war)**
| [3.12.0](https://gerrit-releases.storage.googleapis.com/gerrit-3.12.0.war)

Documentation: **[3.12.1](https://gerrit-documentation.storage.googleapis.com/Documentation/3.12.1/index.html)**
...
- Reindex all indexes:
  ...
  See the
  [reindex](https://gerrit-documentation.storage.googleapis.com/Documentation/3.12.1/pgm-reindex.html)
...
* Enhancements
  * [Change 486062](https://gerrit-review.googlesource.com/c/gerrit/+/486062)
  ...
  Reindexing with the --reuse option may result in having index entries for
  which changes do not exist in noteDb. This change adds index cleanup step which
  is performed after reindexing is done.

  The cleanup is done with one thread per-project and the cleanup is triggered
  immediately after all changes of that project are indexed.
