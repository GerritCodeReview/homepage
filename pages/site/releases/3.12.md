...
* [Issue 454695136](https://issues.gerritcodereview.com/issues/454695136)
  [Change 436417](https://gerrit-review.googlesource.com/c/gerrit/+/436417)
  Upgrade to New H2 v2 storage backend for persistent caches causes corrupt
  cache files.
...
Despite these performance improvements, it has been reported that cache files
can be corrupted when Gerrit is ungracefully restarted.

Please consider using alternative persistent cache backends like:
