...
Download: **[3.12.0](https://gerrit-releases.storage.googleapis.com/gerrit-3.12.0)**
...
Concurrent change insertion fails on ref-table-enabled repositories over NFS.
  ...
  that uses the ref-table and is hosted on an NFS-mounted filesystem. A fix is not yet available,
  and users relying on high-concurrency change creation should avoid using ref-table over NFS.
