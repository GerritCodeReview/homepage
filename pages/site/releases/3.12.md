...
* Plugins
  ...
  * [Issue 428670066](https://issues.gerritcodereview.com/issues/428670066)
    ...
    Fix the prevention of concurrent PushOps the same target URI when using
    multiple threads

  * [Change 477062](https://gerrit-review.googlesource.com/c/plugins/codemirror-editor/+/477062)
   Update plugins/codemirror-editor from branch 'stable-3.12'
      to 6a33a4cc00a318edd62e6743b73cc00a68a9bdc1
