...
Download: **[3.11.9](https://gerrit-releases.storage.googleapis.com/gerrit-3.11.9.war)**
...
Documentation: **[3.11.9](http://gerrit-documentation.storage.googleapis.com/Documentation/3.11.9/index.html)**
...
* [Change 435557](https://gerrit-review.googlesource.com/c/gerrit/+/435557):
  Add [`auth.cookeHttpOnly`](https://gerrit-documentation.storage.googleapis.com
  /Documentation/3.11.0/config-gerrit.html#auth.cookieHttpOnly) option to set
...
* [Change 435998](https://gerrit-review.googlesource.com/c/gerrit/+/435998):
  ...
  This makes the `auth.cookieHttpOnly` cookie more secure by default as there
  should usually be no need to allow client side javascript to access it.
...
on projects containing one or more inconsistent changes.
  ...
  having one or more inconsistent changes, like changes with `refs/meta/*` refs
  coming from unexpected Gerrit `serverId`.
...
* [Change 409734](https://gerrit-review.googlesource.com/409734):
  ...
  /Documentation/3.11.0/config-gerrit.html#accountDeactivation).
...
* [Change 421120](https://gerrit-review.googlesource.com/421120):
  A new `Blocked Users` group that allows admin to block spammers is created automatically during
  the site initialisation.
...
* [Change 422518](https://gerrit-review.googlesource.com/422518):
  Record duration of performance events in nanoseconds (instead of in milliseconds).
...
* [Change 438861](https://gerrit-review.googlesource.com/c/gerrit/+/438861):
  Fixed `ls-projects` command to skip corrupted repositories.
...
* Bug Fixes
  ...
  * [Change 524669](https://gerrit-review.googlesource.com/524669):
  [`gerrit migrate-externalids-to-insensitive`](https://gerrit-documentation.storage.googleapis.com
  /Documentation/3.10.0/cmd-migrate-externalids-to-insensitive.html) SSH command now logs
  all duplicates in dry-run mode.
...
* Bug Fixes
  ...
  * [Change 495501](https://gerrit-review.googlesource.com/495501):
    [`gerrit sequence set`](https://gerrit-documentation.storage.googleapis.com
    /Documentation/3.10.0/cmd-sequence-set.html) SSH command now enforces strictly
