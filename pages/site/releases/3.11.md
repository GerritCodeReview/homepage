...
Download: **[3.11.0-rc4](https://gerrit-releases.storage.googleapis.com/gerrit-3.11.0-rc4.war)**
...
* [Jgit Change 1203547](https://eclipse.gerrithub.io/c/eclipse-jgit/jgit/+/1203547)
  and [Jgit Change 1203548](https://eclipse.gerrithub.io/c/eclipse-jgit/jgit/+/1203548):
  Replace JGit custom encoder with JDK implementation.

  Replaced JGit’s custom encoder with the standard JDK encoder. This drastically improve I/O
...
* JGit changes
    ...
    * [Change 441661](https://gerrit-review.googlesource.com/c/gerrit/+/441661) and
      [Change 442027](https://gerrit-review.googlesource.com/c/gerrit/+/442027):
      Update JGit to d34f8b523

      ```shell
      git log --oneline --no-merges 1cd87ab79...d34f8b523
      ```
