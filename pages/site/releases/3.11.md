...
Download: **[3.11.11](https://gerrit-releases.storage.googleapis.com/gerrit-3.11.11.war)**
| [3.11.10](https://gerrit-releases.storage.googleapis.com/gerrit-3.11.10.war)
| [3.11.9](https://gerrit-releases.storage.googleapis.com/gerrit-3.11.9.war)
| [3.11.8](https://gerrit-releases.storage.googleapis.com/gerrit-3.11.8.war)
...
Documentation: **[3.11.11](http://gerrit-documentation.storage.googleapis.com/Documentation/3.11.11/index.html)**
| [3.11.10](http://gerrit-documentation.storage.googleapis.com/Documentation/3.11.10/index.html)
| [3.11.9](http://gerrit-documentation.storage.googleapis.com/Documentation/3.11.9/index.html)
| [3.11.8](http://gerrit-documentation.storage.googleapis.com/Documentation/3.11.8/index.html)
...
* Plugins
  ...
  * [Change 576244](https://gerrit-review.googlesource.com/c/plugins/replication/+/576244):
  Added `--remote` switch to the replication start command.

    This allows limiting replication to specific remote names without needing to match destination
    URLs.
...
* Bug Fixes
  ...
  * [Change 554841](https://gerrit-review.googlesource.com/c/gerrit/+/554841):
  Fix reviewer-added stream events getting overwritten when processed asynchronously.

    The stream events API now creates an independent reviewer-added event per
    reviewer, avoiding race conditions where asynchronous processing could receive the
    wrong reviewer identity.

* UI Fixes

  * [Change 547445](https://gerrit-review.googlesource.com/c/gerrit/+/547445):
  Fix caret placement in empty `gr-textarea` with placeholder text.

    The placeholder is now rendered out of normal text flow so the caret stays
    at the start of the editable field instead of jumping to the end.

* Enhancements

  * [Change 547483](https://gerrit-review.googlesource.com/c/gerrit/+/547483):
  Improve file-list rendering performance by memoizing patch-change calculations.

    This reduces repeated full-file-list recomputation during render cycles and
    lowers UI main-thread blocking on large changes.
