...
* JGit changes
  * [Change 480029](https://gerrit-review.googlesource.com/c/gerrit/+/480029)
  Bump JGit to 1c7289509
...
* Plugins
  * [Change 473229](https://gerrit-review.googlesource.com/c/gerrit/+/473229)
    Update webhooks plugin from 2e5ec3b to b00a2c2 (master)

  * [Issue 428670066](https://issues.gerritcodereview.com/issues/428670066)
    Update plugins/replication from branch 'stable-3.11'
      to 83e15b020a4693bbc0daa24acf6e08bb9e8f8864

    Fix the prevention of concurrent PushOps the same target URI when using multiple threads
