...
Teams may not grant this permission. In this case reworking changes of other
users is not possible and the considerations discussed here do not apply.
...
by the
[Add Patch Set](https://gerrit-review.googlesource.com/Documentation/access-control.html#category_add_patch_set).
Teams may not grant this permission. In this case rebasing changes of other
users via git push is not possible and the considerations discussed here do not
apply.
