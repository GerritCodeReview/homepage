...
outlined in the [solution doc](support-jujutsu-solution.html).

If Git decides to preseve the `change-id` header on rebase and cherry-pick (see
[here](support-jujutsu-solution.html#git-does-not-preserve-jj-change-ids)) we do
not need to implement any of the mitigations to reach
[compatibility](support-jujutsu-solution.html#compatibility) between Git users
and Jujutsu users.
