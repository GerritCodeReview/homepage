...
| `release-ee11.war` (opt-in) | Servlet API 6.1.0, `jakarta.servlet`, Jetty 12 EE11, Guice 7.0 | Sites whose plugin set is jakarta-ready. |
...
Each WAR is a consistent single-flavour tower before the default flip:

```text
              Two consistent runtime towers

release.war                         release-ee11.war
EE8 / javax.servlet                  EE11 / jakarta.servlet
┌─────────────────────────────┐      ┌─────────────────────────────┐
│ Gerrit EE8                  │      │ Gerrit EE11                 │
│ generated from jakarta srcs │      │ canonical jakarta srcs      │
├─────────────────────────────┤      ├─────────────────────────────┤
│ jgit-servlet-ee8            │      │ jgit-servlet                │
│ generated from JGit jakarta │      │ canonical jakarta           │
├─────────────────────────────┤      ├─────────────────────────────┤
│ gitiles plugin EE8          │      │ gitiles plugin EE11         │
│ generated from jakarta srcs │      │ canonical jakarta srcs      │
│ gitiles-servlet-ee8 2.x     │      │ gitiles-servlet 2.x         │
├─────────────────────────────┤      ├─────────────────────────────┤
│ javamelody plugin EE8       │      │ javamelody plugin EE11      │
│ javamelody-library 1.x      │      │ javamelody-library 2.x      │
├─────────────────────────────┤      ├─────────────────────────────┤
│ javax.servlet-api 4.0.1     │      │ jakarta.servlet-api 6.1.0   │
│ Jetty 12 EE8                │      │ Jetty 12 EE11               │
│ Guice 6                     │      │ Guice 7                     │
└─────────────────────────────┘      └─────────────────────────────┘
```
