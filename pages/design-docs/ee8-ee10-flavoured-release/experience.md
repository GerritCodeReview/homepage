...
`oauth-ee10`, `openid-ee10`, `init-ee10`, `jetty-ee10`) and the `*_ee10` test
...
bazelisk test --@com_googlesource_gerrit_bazlets//flags:flavour=ee10 \
  //javatests/com/google/gerrit/httpd:httpd_tests_ee10 \
  //javatests/com/google/gerrit/util/http:http_tests_ee10
```
